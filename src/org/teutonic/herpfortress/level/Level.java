package org.teutonic.herpfortress.level;

import java.util.*;

import org.teutonic.herpfortress.*;
import org.teutonic.herpfortress.entity.*;
import org.teutonic.herpfortress.entity.pickup.*;
import org.teutonic.herpfortress.particle.Explosion;
import org.teutonic.herpfortress.unit.*;

public class Level {
	public Random random = new Random();

	public List<Entity> entities = new ArrayList<Entity>();
	public List<Sprite> particles = new ArrayList<Sprite>();
	...
	public Level() {
		Bitmap bmp = Art.load("/res/levels/level.png");
